<template>
  <div class="px-4 py-5 my-5 text-center">
    ...
    <h2>Lana Pavić</h2>
    <p>Works in HT from 22.01.2020 <br>
    ...
    <h2>Matija Bevandić</h2>
    <p>
      Last position before applying for Career Shift: Customer Care Agent of the Technical Service of HT. <br>
    ...
    <h2>Filip Husić</h2>
    <p>
      Works in HT from 2020, last position before applying to the Career Shifter program -> Superior call centre agent for business users.
      <br>
